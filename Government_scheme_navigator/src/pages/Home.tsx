...
const Home: React.FC = () => {
  ...
  return (
    <div className="pt-20 bg-app-bg text-app-text transition-colors duration-300">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-app-text-muted max-w-3xl mx-auto mb-12 leading-relaxed">
              {t.hero_subtitle}
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <Link
                to="/about"
                className="w-full sm:w-auto px-8 py-4 rounded-full bg-app-surface text-app-text font-semibold border border-app-border hover:bg-app-surface-hover transition-all"
              >
                {t.learn_more}
              </Link>
            </div>
      ...
      {/* Stats Section */}
      <section className="py-12 border-y border-app-border bg-app-surface/50">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-app-text mb-4">{t.features_title}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -5 }}
                className="p-8 rounded-2xl bg-app-surface border border-app-border hover:border-cyan-500/30 transition-all group shadow-xl"
              >
                ...
                <h3 className="text-xl font-semibold text-app-text mb-4">{feature.title}</h3>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-app-surface border border-app-border rounded-3xl p-12 text-center relative overflow-hidden shadow-2xl">
            <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-500/10 blur-[80px] -z-10"></div>
            <h2 className="text-3xl md:text-4xl font-bold text-app-text mb-6">{t.ready_title}</h2>
            <p className="text-app-text-muted mb-10 max-w-xl mx-auto">
              {t.ready_desc}
            </p>
            <Link
              to="/signup"
              className="inline-flex items-center space-x-2 px-8 py-4 rounded-full bg-cyan-500 text-white font-bold hover:bg-cyan-400 transition-all shadow-xl"
            >
